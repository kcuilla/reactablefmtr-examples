...
reactable(
  ...
  add_source(html("Source: Resolution Foundation <img src='https://www.newstatesman.com/wp-content/uploads/sites/2/2021/09/TNS_master_logo.svg' alt='Palmer Penguins' width='130' height='40' style='vertical-align:middle;margin-left:590px'>"), font_size = 20, margin = reactablefmtr::margin(t=20), font_color = '#858585') %>%
  google_font("Jost")
