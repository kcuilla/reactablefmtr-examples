...
reactable(
  data,
  theme = nytimes(font_size = 15, header_font_size = 13, header_font_color = '#242424', font_color = '#2d2d2d', cell_padding = 7, centered = TRUE),
